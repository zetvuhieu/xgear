...
import laptop1 from "~/assets/images/page_laptop/product/laptop1.jpg";
  ...
  return (
    <div className={cx("laptop")}>
      <div className={cx("laptop_wrap")}>
        <div className={cx("laptop_title")}>Laptop</div>
        <div className={cx("laptop_bar")}>
          <button className={cx("laptop_button")}>
            Intel 13th Gen/RTX 40 Series
          </button>
          <button className={cx("laptop_button")}>Laptop Acer</button>
          <button className={cx("laptop_button")}>Laptop Asus</button>
          <button className={cx("laptop_button")}>Laptop Dell</button>
          <button className={cx("laptop_button")}>Laptop Gigabyte</button>
          <button className={cx("laptop_button")}>Laptop HP</button>
          <button className={cx("laptop_button")}>Laptop Lenovo</button>
          <button className={cx("laptop_button")}>Laptop MSI</button>
        </div>
        <div className={cx("pages_number")}>
          <div>Hiển thị 1–12 của 191 kết quả</div>
